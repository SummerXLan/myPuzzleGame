cc.Class({
  ...
  start() {
    ...
    this.leftBian.node.position = cc.Vec2(
      -cc.winSize.width / 2 + this.leftBian.size.width,
      0
    );

    this.rightBian.node.position = cc.Vec2(
      cc.winSize.width / 2 - this.rightBian.size.width,
      0
    );*/
